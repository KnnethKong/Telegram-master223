...
public class DialogsSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public DialogsSearchAdapter(Context context, int messagesSearch, int type) {
        Log.i("TAG","Type"+type);
        Log.i("TAG","messageSearch"+messagesSearch);
    ...
    public void searchDialogsInternal(final String query, final int searchId) {
        Log.i("TAG","class"+"searchDialogsInternal"+searchId);
        ...
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
            ...
            public void run() {
                try {
                                ...
                                if (name.startsWith(q) || name.contains(" " + q) || tName != null && (tName.startsWith(q) || tName.contains(" " + q))) {
                                    ...
                                    if (data != null) {
                                        ...
                                        if (!(chat == null || chat.deactivated || ChatObject.isChannel(chat) && ChatObject.isNotInChat(chat))) {
                                            ...
                                            Log.i("TAG","chat1"+dialogSearchResult.object.toString());
                                            resultCount++;
                                        }
                                    }
                                    break;
                            ...
                            for (int a = 0; a < search.length; a++) {
                                ...
                                if (found != 0) {
                                    ...
                                    if (chat != null && user != null) {
                                        ...
                                        Log.i("TAG","chat"+chat.toString()+"id+"+chat.id);
                                        if (user.status != null) {
                    ...
                    Log.i("TAG","searchResults"+searchResults.toString()+"\\\\object"+searchResults.get(0).toString());
                    ...
                    Log.i("TAG",resultArray.get(0).toString()+"1111111"+resultArrayNames.get(0));
