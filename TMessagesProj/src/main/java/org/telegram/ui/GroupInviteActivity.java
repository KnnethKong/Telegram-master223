            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == copyLinkRow || position == linkRow) {
                    ...
                    try {
                        ...
                        String linkGroup = GetProxyAddress.getLinkPrefixGroup() + currentChat.username;
                        android.content.ClipData clip = android.content.ClipData.newPlainText("label", linkGroup);
...
//                        intent.putExtra(Intent.EXTRA_TEXT, invite.link);
                        intent.putExtra(Intent.EXTRA_TEXT, linkGroup);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    String linkGroup = GetProxyAddress.getLinkPrefixGroup() + currentChat.username;
                    textBlockCell.setText(linkGroup, false);
                    break;
            }
        }
